...
describe_recipe 'openbsd::hostnameif' do
  it 'creates /etc/hostname.carp0' do
    ...
    hostnameif.must_include 'advbase 1 advskew 100 vhid 1 pass secret carpdev vlan100
...
inet6 2001:db8:6dc:7aa::10 64'
  ...
  it 'creates /etc/hostname.carp1' do
    ...
    hostnameif.must_exist.with(:mode, "640").with(:owner, "root").with(:group, "wheel")
    hostnameif.must_include 'advbase 1 advskew 100 vhid 20 pass secret carpdev vlan101
inet 10.0.15.10 255.255.255.0
inet6 2001:db8:6dc:7ff::10 96
!route add 10.0.30.0/24 10.0.15.30'
  end
